...
for image_file in image_files:
    ...
    for mask_data in masks:
        ...
        try:
            ...
            for i in range(x):
                output_image_fname = join(body_part_folder, 'img', pid, scanid, pid_scanid + "_"+ str(i) + ".png")
                output_label_fname = join(body_part_folder, 'labelcol', pid, scanid, pid_scanid + "_" + str(i) + ".png")
